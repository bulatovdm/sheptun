...
sheptun analyze-replacements --max-iterations 5 --batch-size 20 --min-confidence high
...
| `--batch-size N` | `BATCH_SIZE` | Окон в одном запросе к модели (20) |
...
| — | `EFFORT` | Глубина рассуждений модели — low…max (medium; меньше = быстрее) |
